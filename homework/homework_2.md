...
## Problem 1: DSB-SC Fundamentals (10 points)
...
**(a)** Write the expression for the DSB-SC modulated signal $s(t)$. (2 points)

**(b)** Use trigonometric identities to express $s(t)$ as a sum of two sinusoids and identify the upper and lower sideband frequencies. (4 points)
...
## Problem 2: Full Carrier AM (12 points)

An AM broadcast station transmits with a carrier frequency of $1.2 \text{ MHz}$. The carrier amplitude is $A_c = 100 \text{ V}$ and the message signal is $m(t) = 60\cos(2\pi \cdot 5000 \cdot t) \text{ V}$.

**(a)** Write the complete expression for the AM signal $s(t)$. (3 points)

**(b)** What is the modulation index $\mu$? (3 points)

**(c)** Sketch one complete cycle of the modulating signal showing the envelope of the AM waveform. Label key amplitudes. (3 points)

**(d)** Calculate the total transmitted power and the percentage of power in the sidebands vs. the carrier (assume $50 \, \Omega$). (3 points)

---

## Problem 3: Modulation Index and Overmodulation (10 points)

An AM transmitter has carrier amplitude $A_c = 50 \text{ V}$.

**(a)** What is the maximum message amplitude $A_m$ that can be used without overmodulation? (2 points)

**(b)** If $m(t) = 40\cos(2\pi \cdot 3000 \cdot t) \text{ V}$, calculate the modulation index and determine if the signal is overmodulated. (2 points)

**(c)** Sketch the AM envelope for $\mu = 0.5$, $\mu = 1.0$, and $\mu = 1.5$. Explain what happens during overmodulation. (6 points)

---

## Problem 4: Envelope Detection (8 points)
...
**(a)** Sketch a simple envelope detector circuit (diode, RC components). (2 points)

**(b)** What is the requirement on the RC time constant to avoid distortion? Express in terms of the carrier frequency $f_c$ and the maximum message frequency $f_m$. (3 points)

**(c)** What happens if the RC time constant is too large? Too small? (3 points)

---

## Problem 5: AM Bandwidth and Spectral Efficiency (10 points)

An AM radio station broadcasts audio from $50 \text{ Hz}$ to $5 \text{ kHz}$.

**(a)** What is the RF bandwidth required for DSB-SC? For full carrier AM? (3 points)
...
**(c)** Calculate the spectral efficiency (bits/s/Hz) if the audio is digitized at 8 bits per sample with Nyquist rate sampling, then transmitted using AM. (3 points)

---

## Problem 6: On-Off Keying (ASK) (12 points)
...
**(a)** Write the expression for the OOK signal during transmission of a "1" bit. (2 points)

**(b)** Sketch the transmitted waveform $s(t)$ for the entire data sequence. Show at least 3 carrier cycles per bit. (4 points)

**(c)** What is the null-to-null bandwidth of the OOK signal? (3 points)

**(d)** How does this compare to the bandwidth of the unmodulated baseband data stream? (3 points)

---

## Problem 7: Binary ASK Spectral Analysis (10 points)
...
**(b)** The baseband rectangular pulse has a sinc-shaped spectrum. What is the first null bandwidth of the baseband signal? (3 points)

**(c)** After modulation to $f_c = 2.4 \text{ GHz}$, what frequencies define the main lobe of the ASK spectrum? (3 points)

**(d)** Compare the bandwidth efficiency of ASK to DSB-SC AM for the same baseband signal. (2 points)

---

## Problem 8: AM vs. ASK Comparison (8 points)

**(a)** Explain the fundamental difference between analog AM and digital ASK. What do they have in common? (3 points)

**(b)** Both AM and ASK can use envelope detection. Why is this possible? (3 points)

**(c)** Why might ASK be preferred over AM in a digital communication system? (2 points)

---

## Problem 9: Superheterodyne Receiver (10 points - Challenge)

An AM broadcast receiver uses the superheterodyne architecture with an intermediate frequency (IF) of $455 \text{ kHz}$.

**(a)** If you want to receive a station at $1200 \text{ kHz}$, to what frequency should the local oscillator (LO) be tuned? (2 points)

**(b)** What is the image frequency for this receiver? (4 points)

**(c)** If an interfering signal exists at the image frequency, explain what problem this causes. How do receivers mitigate this? (4 points)
...
- Maximum transmit power: $150 \text{ W}$
- Carrier amplitude: $A_c = 100 \text{ V}$
- Load resistance: $50 \, \Omega$

**(a)** Assuming single-tone modulation, what is the maximum modulation index you can use to stay within the $150 \text{ W}$ power budget? (5 points)
...
Show that the carrier power is $P_c = \frac{A_c^2}{2}$ and the total sideband power is $P_{sb} = \frac{\mu^2 A_c^2}{2} \cdot P_m$, where $P_m$ is the normalized message power.
